...
// const OtpInput: React.FC<OtpInputProps> = ({ numOfBoxes = 6 }) => {
...
//         <div
//           key={index}
//           className={`w-[64px] h-[64px] border-[1.5px] border-solid border-custom-gray rounded-2xl overflow-hidden flex items-center justify-center ${focusedIndex === index || values[index] ? 'border-dark-purple' : ''}`}
//         >
//           <input
//             type='text'
//             maxLength={1}
//             className='w-[15px] h-full font-bold text-[16px] border-none outline-none text-center'
